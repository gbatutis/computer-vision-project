...
# Process 60 tiles
for tile_number in tqdm(range(1, 19)):
...
#save the data
np.savez_compressed("/Users/gbatu/OneDrive/Documents/NYU/Semester_3/CV/val_labels.npz",labels=final_labels) #stacked_tensor=stacked_tensor, 
print("complete")